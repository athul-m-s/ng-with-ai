...
@Component({
  ...
  styles: [`
    :host { display: block; }
    .bento-card--entertainment { width: 100%; height: 100%; }
    .ent-block {
      display: flex;
      align-items: center;
      gap: 0.9rem;
    ...
    .ent-block:not(.ent-static):hover { transform: translateX(4px); }
    .ent-block:not(.ent-static):hover .ent-arrow { opacity: 1; transform: translate(2px, -2px); }
    .ent-block:not(.ent-static):active { transform: scale(0.97); transition-duration: 0.07s; }
    .ent-static { cursor: default; }
    .ent-icon {
      width: 34px;
      height: 34px;
      border-radius: 9px;
    ...
    .ent-info { flex: 1; display: flex; flex-direction: column; gap: 0.08rem; }
    .ent-label { font-size: 0.85rem; font-weight: 600; color: rgba(255,255,255,0.85); }
    .ent-sub { font-size: 0.72rem; color: rgba(255,255,255,0.3); }
    .ent-arrow {
      font-size: 0.82rem;
    ...
    .ent-divider { height: 1px; background: rgba(255,255,255,0.06); margin: 0.1rem 0; }
  `],
})
