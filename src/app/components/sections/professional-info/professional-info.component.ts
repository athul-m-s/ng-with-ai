          ...
          <div class="glass-item">
            ...
            <div class="job-header">
              <div class="job-dot-col">
                <span
                  class="job-dot"
                  [class.job-dot--active]="job.current"
                  [attr.aria-label]="job.current ? 'Current role' : 'Past role'"
                ></span>
      ...
      projects: [
        {
          ...
          tags: ['Angular 11→18', '.NET Core', 'MongoDB', 'Microservices', 'C#'],
        },
      ],
    },
    {
      ...
      projects: [
        {
          name: 'Akbar Travels (akbartravels.com)',
          period: 'Jul 2019 – Aug 2021',
          tags: ['Angular', 'Cashfree Payment', 'Flight & Hotel Booking', 'Travel Domain'],
        },
      ],
    },
  ];
